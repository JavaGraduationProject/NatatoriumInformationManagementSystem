...
<input type="hidden" value="${param.flag }" name="flag"/>
			...
			<center>
				...
				<tr height="25">
					...
					<td class="outDetail2">
						<select id="employeeId" name="employeeId">
							<c:forEach items="${employeeList }" var="lists">
								<option value="${lists.id }" ${map.employeeId==lists.id?'selected':'' }>${lists.employeeName
									}</option>
							</c:forEach>
					</select>
					</td>
				...
				<tr height="25">
					...
					<td class="outDetail2">
						<input readonly="readonly" name="yf" id="yf" value="${map.yf }" type="text" onClick="WdatePicker({dateFmt:'yyyy-MM'})"/>
					</td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">
					...
					<td class="outDetail2">
						<input id="fee1" type="text" value="${map.fee1 }" name="fee1"/>
					</td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">
					...
					<td class="outDetail2">
						<input id="fee2" type="text" value="${map.fee2 }" name="fee2"/>
					</td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">
					...
					<td class="outDetail2">
						<input id="fee3" type="text" value="${map.fee3 }" name="fee3"/>
					</td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">
					...
					<td class="outDetail2">
						<textarea rows="5"  id="remark" cols="50" name="remark">${map.remark }</textarea>
					</td>
				</tr>
		<c:if test="${1==1 }"></c:if>
